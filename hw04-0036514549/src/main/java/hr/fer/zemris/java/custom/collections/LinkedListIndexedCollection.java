...
public class LinkedListIndexedCollection<T> implements List<T> {
	 ...
	 * 
	 * @param <S> the type of object stored in this node
	 */
	private static class ListNode<S> {	
		/**
		 * Pointer to the previous list node.
		 */
		private ListNode<S> previous;
		/**
	 ...
	 */
	private static class LinkedListIndexedCollectionElementsGetter<S> implements ElementsGetter<S> {

		/**
		 * Reference to the collection.
		 */
		private LinkedListIndexedCollection<S> collection;
		
		/**
		 * Index of current element.
		 */
		private ListNode<S> currentNode;
		 ...
		 */
		public LinkedListIndexedCollectionElementsGetter(LinkedListIndexedCollection<S> collection) {

...
/**
 * Implementation of {@link IWebWorker} that generates HTML page with current time
 * displayed and outputs message depending whether the parameter called "name" was 
 * provided.
 */

...
public class LinkedListIndexedCollection extends Collection {
	 ...
	 * position. Valid indexes are 0 to {@code size()} - 1.
	 * 
	 * @param  index the position of the wanted object
	 * @return       the object at the given position
	 * @throws IndexOutOfBoundsException if {@code position < 0 || position > size() - 1} 
	 */

...
public interface CalcModel {
	...
	/**
	 * Zamrzava prikaz tako da ostaje prikazana predana vrijednost sve dok se
	 * prikaz ne odmrzne na način da se kao vrijednost preda <code>null</code>.
	 * 
	 * @param value vrijednost koju treba zamrznuti
	 */
	 ...
	 * 
	 * @return <code>true</code> ako postoji zamrznuta vrijednost, <code>false</code> inače
	 */
